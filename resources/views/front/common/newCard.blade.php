<div>
    ...
    <div>
        <a href="#"><h3 class="text-2xl font-medium hover:text-blue-700 pt-5">{{$new['title']}}</h3></a>
        <i class="fa-regular fa-calendar-days text-gray-600 text-lg pt-5 md:pt-10"></i><span class="px-2 text-gray-600 font-medium text-base">{{$new['created_at']}}</span>
