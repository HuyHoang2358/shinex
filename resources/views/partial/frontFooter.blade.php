...
<div class="container mx-auto xl:px-36 bg-blue-400 flex justify-between items-center py-3">
    <!-- List icon -->
    <div class="flex justify-start items-center gap-2 md:gap-5 text-xl md:text-2xl px-4">
        <div class="w-8 h-8 md:w-10 md:h-10 bg-white rounded-full p-2 text-blue-600 flex justify-center items-center">
            <a href="{{Config::get('website.url_facebook')}}">
                <i class="fa-brands fa-facebook hover:rotate-45 duration-700 ease-in-out md:text-3xl"></i>
            </a>
        </div>

        <div class="w-8 h-8 md:w-10 md:h-10 bg-white rounded-full p-2 text-pink-500 flex justify-center items-center">
        ...
        <div class="w-8 h-8 md:w-10 md:h-10 bg-white rounded-full p-2 text-black flex justify-center items-center">
            <a href="{{Config::get('website.url_instagram')}}">
                <i class="fa-brands fa-instagram hover:rotate-45 duration-700 ease-in-out"></i>
            </a>
        </div>

        <div class="w-8 h-8 md:w-10 md:h-10 bg-white rounded-full p-2 text-red-600 flex justify-center items-center">
...
<div class="container mx-auto xl:px-36 py-8">
    <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        <div class="col-span-1 p-4">
            <img class="w-full pb-5 max-w-[200px]" src="{{asset('/images/logo/logo.png')}}" alt="shinex-logo" style="margin:0px auto">
        ...
        <div class="col-span-1 p-4">
            <div>
                <h4 class="py-3 text-base font-bold text-black tracking-wider">NHÀ PHÂN PHỐI ĐỘC QUYỀN</h4>
                <p class="text-base text-blue-600 font-semibold ">Viện Thẩm Mỹ Quốc Tế Jolly</p>
            </div>
            <div>
                <h4 class="py-3 text-base font-bold text-black tracking-wider">GIỜ MỞ CỬA</h4>
                <p class="text-sm">Từ 9:00 - đến 21:30 </p>
            </div>
            <div class="py-2">
