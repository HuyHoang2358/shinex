<nav class="px-96 pt-10 pb-5 flex justify-between">
    <div>
        <a href="#">
...
<div>
    <div class="relative">
        ...
        <div class="h-20 bg-white absolute left-[50%] translate-x-[-50%] bottom-[-40px] flex items-center  px-24 border-[1px] border-gray-300 gap-16">
            ...
            <div class="flex justify-center items-center gap-3">
                <div>
                    <div class="h-10 w-10 bg-pink-300"></div>
                </div>
                <div>
...
<div class="px-72 flex my-10 py-10">
...
<div class="text-center px-56 py-10">
    <h1 class="text-3xl font-semibold text-blue-800 pb-3 text-center px-96">Hợp tác quốc tế với nhiều nhà cung cấp nguyên liệu hàng đầu trong và ngoài nước</h1>
    <div class="flex justify-center">
        <img src="{{asset('/images/logo/symbolsection.webp')}}" alt="">
    </div>
    ...
    <div class="flex justify-between gap-28">
        <div class="flex flex-col justify-center items-center gap-5">
            ...
            <p class="text-xl text-gray-500">Các sản phẩm SHINEX được nhập khẩu từ nước ngoài, đảm bảo chất lượng từ nguồn giúp các hoạt chất của chúng có tác động tốt hơn trên da.</p>
        </div>
        <div class="flex flex-col justify-center items-center gap-5">
            <img class="w-48" src="{{asset('/images/logo/nature.png')}}" alt="">
            <p class="text-xl text-gray-500">Với thành phần tự nhiên, chiết xuất khoa học và công nghệ, loại bỏ các chất kích ứng gây hại cho da. Với nhà máy PIC/SGMP hàng đầu trong ngành và nhà xưởng vô trùng, quá trình sản xuất tuân thủ nghiêm ngặt các tiêu chuẩn dược phẩm quốc tế trước khi được cơ quan bên thứ ba kiểm nghiệm trên thị trường đảm bảo an toàn cao nhất.</p>
        </div>
        <div class="flex flex-col justify-center items-center gap-5">
            <img class="w-48 pb-2 pt-3" src="{{asset('/images/logo/heal.png')}}" alt="">
            <p class="text-xl text-gray-500">Tiêu chuẩn dược phẩm quốc tế, trước khi đưa ra thị trường được kiểm nghiệm bởi các cơ quan bên thứ ba, phù hợp với các nguyên tắc giám sát an toàn cao nhất.</p>
        </div>
    </div>
</div>
